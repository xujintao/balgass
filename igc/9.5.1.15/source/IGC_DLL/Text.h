...
#define TEXT_GET_CONTEXT 0x0045130C // 1.04R
//00451363   55               PUSH EBP


#define TEXT_PRINT 0x004515A3 // 1.04R
#define TEXT_SET_FONT 0x0045157B // 1.04R
#define TEXT_SET_COLOR 0x004514FA // 1.04R
#define TEXT_SET_BK_COLOR 0x00451522 // 1.04R
