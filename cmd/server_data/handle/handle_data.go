...
func loginJoinServer(server *model.Server, req *network.Request) {
	msg := &model.ServerLoginMsg{}
	proto.Unmarshal(req.Body, msg)
	service.ServerManager.
}

func accountReq(server *model.Server, req *network.Request) {
	account := &model.Account{}
	proto.Unmarshal(req.Body, account)
